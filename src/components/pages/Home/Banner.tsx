...
export const Banner: React.FC<IHomeBannerProps> = () => (
  <div className="grid w-full h-screen grid-cols-2 ">
    ...
    >
      ...
      <h2 className="text-2xl font-semibold text-sblack-222 ">Travel Anytime, Anywhere.</h2>
      ...
      <div className="grid items-center grid-cols-2 gap-4 my-4 text-lg font-bold ">
        <Link href="/user/signup" passHref>
          <a className="grid py-2 text-white bg-opacity-50 rounded bg-gradient-to-br from-kgreen-600 place-items-center to-kgreen-400">
            Join
          </a>
        </Link>
      ...
      <div className="text-black t text-opacity-70">
        <p>The most popular carpooling platform in Tunisia with +1000 users & +100 daily offers</p>
      </div>
    </div>
