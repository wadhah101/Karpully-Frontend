  ...
  <div className="">
    <div className="text-center">
      ...
      <p className="mt-6 mb-10 text-xl text-black text-opacity-80">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi, eligendi quaerat
        dignissimos cum, quidem odio, possimus repellendus assumenda reiciendis nemo iste doloribus
        quis tempora. Quos rerum hic atque sunt pariatur!
      </p>
    </div>
    <div className="grid md:grid-cols-3 gap-x-10">
      {BLOCKS.map((e) => (
        <div className="p-3 border border-black shadow border-opacity-10" key={e.title}>
