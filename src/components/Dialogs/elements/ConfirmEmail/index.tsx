import { AppPortals, BaseDiagleProps } from '@comp/Dialogs/data';
  ...
  return (
    <div className="relative w-[40rem] bg-white rounded">
      ...
      <div className="flex flex-col items-center p-6">
        ...
        <Dialog.Description as="h3" className="mt-6 text-lg text-black text-opacity-50">
          We have Sent email to&nbsp;
          <span className=" text-kgreen-500">{email}</span>
          &nbsp;to confirm the validity of your email adress. After receiving the email follow the
