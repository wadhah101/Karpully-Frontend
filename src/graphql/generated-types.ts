...
export type CreateCarpoolInput = {
  ...
  description: Scalars['String']
  hasSmokePermission: Scalars['Boolean']
  departureCityId: Scalars['Float']
  destinationCityId: Scalars['Float']
}
...
export type Location = {
  ...
  osm_type: Scalars['String']
  osm_id: Scalars['String']
  boundingbox: Array<Scalars['String']>
  lat: Scalars['String']
  lon: Scalars['String']
...
export type UpdateCarpoolInput = {
  ...
  departureCityId?: Maybe<Scalars['Float']>
...
export type SignUpStage2Mutation = { __typename?: 'Mutation' } & {
  secondStageSignUp: { __typename?: 'User' } & Pick<
    User,
    | 'id'
    | 'username'
    | 'firstname'
...
export type EmailExistsQuery = { __typename?: 'Query' } & Pick<
  Query,
  'existByEmail'
>
...
export type RefreshTokenQueryHookResult = ReturnType<
  typeof useRefreshTokenQuery
>
export type RefreshTokenLazyQueryHookResult = ReturnType<
  typeof useRefreshTokenLazyQuery
>
...
export function useSignUpStage1Mutation(
  ...
  return Apollo.useMutation<
    SignUpStage1Mutation,
    SignUpStage1MutationVariables
  >(SignUpStage1Document, options)
}
export type SignUpStage1MutationHookResult = ReturnType<
  typeof useSignUpStage1Mutation
>
...
export function useSignUpStage2Mutation(
  ...
  return Apollo.useMutation<
    SignUpStage2Mutation,
    SignUpStage2MutationVariables
  >(SignUpStage2Document, options)
}
export type SignUpStage2MutationHookResult = ReturnType<
  typeof useSignUpStage2Mutation
>
...
export function useCarpoolsQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<CarpoolsQuery, CarpoolsQueryVariables>(
    CarpoolsDocument,
    options
  )
}
export function useCarpoolsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CarpoolsQuery,
    CarpoolsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<CarpoolsQuery, CarpoolsQueryVariables>(
    CarpoolsDocument,
    options
  )
}
export type CarpoolsQueryHookResult = ReturnType<typeof useCarpoolsQuery>
export type CarpoolsLazyQueryHookResult = ReturnType<
  typeof useCarpoolsLazyQuery
>
export type CarpoolsQueryResult = Apollo.QueryResult<
  CarpoolsQuery,
  CarpoolsQueryVariables
>
...
export type EmailExistsLazyQueryHookResult = ReturnType<
  typeof useEmailExistsLazyQuery
>
